...
char* _simulate_heat_transfer_1D_serial(double time_step, double time_limit,
                                      double space_step,
                                      ll precision)
{
    ...
    sprintf(_file_name, "Simulation/Thermo 1D Serial/simulate_heat_transfer_1D_serial_%d-%02d-%02d_%02d-%02d-%02d.sim", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
...
char* _simulate_heat_transfer_2D_serial(double time_step, double time_limit,
                                      double space_step_x,
                                      double space_step_y,
                                      ll precision)
{
    ...
    time_t t = time(NULL);
    struct tm tm = *localtime(&t);
    sprintf(_file_name, "Simulation/Thermo 2D Serial/simulate_heat_transfer_2D_serial_%d-%02d-%02d_%02d-%02d-%02d.sim", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec);
    fptr = fopen(_file_name, "w");
